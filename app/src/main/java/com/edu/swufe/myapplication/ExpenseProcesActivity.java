...
public class ExpenseProcesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView( R.layout.activity_expense_proces );
        //接收传递过来的参数
        ...
        cost_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                Intent i = new Intent(ExpenseProcesActivity.this, KeyPadActivity.class);
    ...
    private void initSpinner(){
        if(type == 0){
            ...
            defaultSubCategory_info = new String[] { "兼职", "投资" ,"奖金","加班","利息","工资" };
            //子类别
            subCategory_info = new String[][] {
                    { "兼职", "投资" ,"奖金","加班","利息","工资" },
                    { "经营", "意外" ,"中奖","礼金" }};
            //账户
            accountList = new String[] { "现金账户", "金融账户","虚拟账户","负债账户" };
            //商家
            shopList = new String[] { "银行", "公交","饭堂","商场","超市","其他" };
            //备注
            noteList = new String[] {  "旅游","装修","报销","出差","其他" };
        }else{
            bigCategoryList = new String[] { "服饰", "食品","日常","交通","通讯","娱乐","学习"
                    ,"人情","医疗","保险","其他" };
            ...
            //账户
            accountList = new String[] { "银行卡", "公交卡","饭卡","支付宝","现金","其他" };
            //商家
            shopList = new String[] { "银行", "公交","食堂","商场","超市","其他" };
            //备注
            noteList = new String[] {  "旅游","装修","公司报销","出差","其他" };
        }
